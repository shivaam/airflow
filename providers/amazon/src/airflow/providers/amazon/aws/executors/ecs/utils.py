...
class EcsTaskCollection:
    ...
    def __init__(self):
        self.key_to_arn: dict[TaskInstanceKey | str, str] = {}
        self.arn_to_key: dict[str, TaskInstanceKey | str] = {}
        self.tasks: dict[str, EcsExecutorTask] = {}
        self.key_to_failure_counts: dict[TaskInstanceKey | str, int] = defaultdict(int)
        self.key_to_task_info: dict[TaskInstanceKey | str, EcsTaskInfo] = {}
    ...
    def add_task(
        ...
        arn = task.task_arn
        self.tasks[arn] = task
        self.key_to_arn[airflow_workload_key] = arn
        self.arn_to_key[arn] = airflow_workload_key
        self.key_to_task_info[airflow_workload_key] = EcsTaskInfo(airflow_cmd, queue, exec_config)
        self.key_to_failure_counts[airflow_workload_key] = attempt_number
    ...
    def task_by_key(self, task_key: TaskInstanceKey | str) -> EcsExecutorTask:
    ...
    def pop_by_key(self, task_key: TaskInstanceKey | str) -> EcsExecutorTask:
